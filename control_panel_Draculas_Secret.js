...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let Draculas_SecretWins = parseInt(document.getElementById("Draculas_Secret-wins").textContent);
  let Draculas_SecretLosses = parseInt(document.getElementById("Draculas_Secret-losses").textContent);
  ...
  updateSuccessRate(Draculas_SecretWins, Draculas_SecretLosses);

  document.getElementById("Draculas_Secret-win-button").addEventListener("click", function () {
    Draculas_SecretWins++;
    document.getElementById("Draculas_Secret-wins").textContent = Draculas_SecretWins;
    updateSuccessRate(Draculas_SecretWins, Draculas_SecretLosses);
  });

  document.getElementById("Draculas_Secret-loss-button").addEventListener("click", function () {
    Draculas_SecretLosses++;
    document.getElementById("Draculas_Secret-losses").textContent = Draculas_SecretLosses;
    updateSuccessRate(Draculas_SecretWins, Draculas_SecretLosses);
  });
});

<script defer src="../public/control_panel_Draculas_Secret.js"></script>
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  updateSuccessRate("Draculas_Secret", Draculas_SecretWins, Draculas_SecretLosses);
...
resetButton.addEventListener("click", () => {
  ...
  // Reset success rate
  const Draculas_SecretWins = parseInt(document.getElementById("Draculas_Secret-wins").textContent);
  const Draculas_SecretLosses = parseInt(document.getElementById("Draculas_Secret-losses").textContent);
  updateSuccessRate("Draculas_Secret", Draculas_SecretWins, Draculas_SecretLosses);
});
