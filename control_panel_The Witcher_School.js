...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let The_Witcher_SchoolWins = parseInt(document.getElementById("The_Witcher_School-wins").textContent);
  let The_Witcher_SchoolLosses = parseInt(document.getElementById("The_Witcher_School-losses").textContent);
  ...
  updateSuccessRate(The_Witcher_SchoolWins, The_Witcher_SchoolLosses);

  document.getElementById("The_Witcher_School-win-button").addEventListener("click", function () {
    The_Witcher_SchoolWins++;
    document.getElementById("The_Witcher_School-wins").textContent = The_Witcher_SchoolWins;
    updateSuccessRate(The_Witcher_SchoolWins, The_Witcher_SchoolLosses);
  });

  document.getElementById("The_Witcher_School-loss-button").addEventListener("click", function () {
    The_Witcher_SchoolLosses++;
    document.getElementById("The_Witcher_School-losses").textContent = The_Witcher_SchoolLosses;
    updateSuccessRate(The_Witcher_SchoolWins, The_Witcher_SchoolLosses);
  });
});

<script defer src="../public/control_panel_The_Witcher_School.js"></script>
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  updateSuccessRate("The_Witcher_School", The_Witcher_SchoolWins, The_Witcher_SchoolLosses);
...
resetButton.addEventListener("click", () => {
  ...
  // Reset success rate
  const The_Witcher_SchoolWins = parseInt(document.getElementById("The_Witcher_School-wins").textContent);
  const The_Witcher_SchoolLosses = parseInt(document.getElementById("The_Witcher_School-losses").textContent);
  updateSuccessRate("The_Witcher_School", The_Witcher_SchoolWins, The_Witcher_SchoolLosses);
});
