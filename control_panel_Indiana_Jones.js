...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let Indiana_JonesWins = parseInt(document.getElementById("Indiana_Jones-wins").textContent);
  let Indiana_JonesLosses = parseInt(document.getElementById("Indiana_Jones-losses").textContent);
  ...
  updateSuccessRate(Indiana_JonesWins, Indiana_JonesLosses);

  document.getElementById("Indiana_Jones-win-button").addEventListener("click", function () {
    Indiana_JonesWins++;
    document.getElementById("Indiana_Jones-wins").textContent = Indiana_JonesWins;
    updateSuccessRate(Indiana_JonesWins, Indiana_JonesLosses);
  });

  document.getElementById("Indiana_Jones-loss-button").addEventListener("click", function () {
    Indiana_JonesLosses++;
    document.getElementById("Indiana_Jones-losses").textContent = Indiana_JonesLosses;
    updateSuccessRate(Indiana_JonesWins, Indiana_JonesLosses);
  });
});

<script defer src="../public/control_panel_Indiana_Jones.js"></script>
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  updateSuccessRate("Indiana_Jones", Indiana_JonesWins, Indiana_JonesLosses);
...
resetButton.addEventListener("click", () => {
  ...
  // Reset success rate
  const Indiana_JonesWins = parseInt(document.getElementById("Indiana_Jones-wins").textContent);
  const Indiana_JonesLosses = parseInt(document.getElementById("Indiana_Jones-losses").textContent);
  updateSuccessRate("Indiana_Jones", Indiana_JonesWins, Indiana_JonesLosses);
});
