...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let Lord_of_the_RingsWins = parseInt(document.getElementById("Lord_of_the_Rings-wins").textContent);
  let Lord_of_the_RingsLosses = parseInt(document.getElementById("Lord_of_the_Rings-losses").textContent);
  ...
  updateSuccessRate(Lord_of_the_RingsWins, Lord_of_the_RingsLosses);

  document.getElementById("Lord_of_the_Rings-win-button").addEventListener("click", function () {
    Lord_of_the_RingsWins++;
    document.getElementById("Lord_of_the_Rings-wins").textContent = Lord_of_the_RingsWins;
    updateSuccessRate(Lord_of_the_RingsWins, Lord_of_the_RingsLosses);
  });

  document.getElementById("Lord_of_the_Rings-loss-button").addEventListener("click", function () {
    Lord_of_the_RingsLosses++;
    document.getElementById("Lord_of_the_Rings-losses").textContent = Lord_of_the_RingsLosses;
    updateSuccessRate(Lord_of_the_RingsWins, Lord_of_the_RingsLosses);
  });
});

<script defer src="../public/control_panel_Lord_of_the_Rings.js"></script>
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  updateSuccessRate("Lord_of_the_Rings", Lord_of_the_RingsWins, Lord_of_the_RingsLosses);
...
resetButton.addEventListener("click", () => {
  ...
  // Reset success rate
  const Lord_of_the_RingsWins = parseInt(document.getElementById("Lord_of_the_Rings-wins").textContent);
  const Lord_of_the_RingsLosses = parseInt(document.getElementById("Lord_of_the_Rings-losses").textContent);
  updateSuccessRate("Lord_of_the_Rings", Lord_of_the_RingsWins, Lord_of_the_RingsLosses);
});
