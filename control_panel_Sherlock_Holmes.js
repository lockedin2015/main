...
document.addEventListener("DOMContentLoaded", () => {
    ...
    let Sherlock_HolmesWins = parseInt(document.getElementById("Sherlock_Holmes-wins").textContent);
    let Sherlock_HolmesLosses = parseInt(document.getElementById("Sherlock_Holmes-losses").textContent);
    ...
    updateSuccessRate(Sherlock_HolmesWins, Sherlock_HolmesLosses);
  
    document.getElementById("Sherlock_Holmes-win-button").addEventListener("click", function () {
      Sherlock_HolmesWins++;
      document.getElementById("Sherlock_Holmes-wins").textContent = Sherlock_HolmesWins;
      updateSuccessRate(Sherlock_HolmesWins, Sherlock_HolmesLosses);
    });
  
    document.getElementById("Sherlock_Holmes-loss-button").addEventListener("click", function () {
      Sherlock_HolmesLosses++;
      document.getElementById("Sherlock_Holmes-losses").textContent = Sherlock_HolmesLosses;
      updateSuccessRate(Sherlock_HolmesWins, Sherlock_HolmesLosses);
    });
  });
  
  <script defer src="../public/control_panel_Sherlock_Holmes.js"></script>
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    updateSuccessRate("Sherlock_Holmes", Sherlock_HolmesWins, Sherlock_HolmesLosses);
  ...
  resetButton.addEventListener("click", () => {
    ...
    // Reset success rate
    const Sherlock_HolmesWins = parseInt(document.getElementById("Sherlock_Holmes-wins").textContent);
    const Sherlock_HolmesLosses = parseInt(document.getElementById("Sherlock_Holmes-losses").textContent);
    updateSuccessRate("Sherlock_Holmes", Sherlock_HolmesWins, Sherlock_HolmesLosses);
  });
